...
public class Activity2 extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO: (2) Use Bundle to retrieve name string
        //TODO: (3) Display "Welcome 'username' "
        //TODO: (4) Set image resource (Hint: drawable) and its touch listener
    ...
    private OnTouchListener imgListener = new OnTouchListener() {
        ...
        // TODO: (1) Handle different touch events in onTouch method
        // TODO: (2) You can use v.layout() to change dinosaur's position
        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch(event.getAction()){
                ...
                case MotionEvent.ACTION_MOVE: //ACTION_MOVE
                    ...
                    v.layout(mx, my, v.getWidth()+mx, v.getHeight()+my);
